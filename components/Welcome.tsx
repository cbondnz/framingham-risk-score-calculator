  ...
  return (
    <section className="text-lg h-screen sm:bg-bg sm:bg-no-repeat sm:bg-right-top bg-half sm:text-base xl:bg-contain">
      <div className="sm:max-w-2xl sm:mx-auto sm:flex sm:flex-col sm:justify-center h-full md:max-w-2xl md:justify-start lg:max-w-4xl xl:max-w-7xl xl:justify-center">
        ...
        <p className="sm:w-3/5 md:text-2xl md:font-medium md:w-5/6 lg:w-3/5 lg:text-xl xl:text-2xl xl:w-4/5">Use this calculator to estimate the risk of developing coronary heart disease for a person over the next 10 years.</p>
