...
const SelectedOptions: FC<ChildComponentProps> = ({ gender, age, smoker, totalChol, hdlChol, treated, bloodPressure, risk }) => {
  return (
    <aside className="hidden w-1/3 bg-white rounded-full p-6 border-2 border-primary shadow-box sm:flex flex-col sm:p-3 lg:p-6">
      <h3 className="text-2xl font-semibold sm:text-lg text-center lg:text-2xl xl:text-2xl xl:mb-5">Selected Options</h3>
      <ul className="p-0 list-inside list-none">
        <li className="mb-8 text-md before:text-red before:mr-2 before:content-['\2665'] sm:text-xs sm:mb-6 lg:text-base lg:mb-8 md:mb-8 xl:text-xl xl:mb-10">
